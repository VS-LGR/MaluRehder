...
export function StylingConsultationSection() {
  ...
  return (
    <section className="border-y border-amber-950/8 bg-[#fbfaf7] py-14 md:py-16">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-6 md:grid-cols-2 md:items-center md:gap-12">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-neutral-600 md:text-[15px]">{intro}</p>
        </div>
        <div className="rounded-2xl border border-amber-200/25 bg-neutral-950 p-8 text-[#f2ebe2] shadow-[0_24px_48px_rgba(0,0,0,0.12)]">
